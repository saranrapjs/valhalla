...
void ParseBicycleCostOptions(const rapidjson::Document& doc,
  ...
  JSON_PBF_RANGED_DEFAULT(co, kUseOnewaysRange, json, "/use_oneways", use_oneways, warnings);
  JSON_PBF_RANGED_DEFAULT(co, kUseBikepathsRange, json, "/use_bikepaths", use_bikepaths, warnings);
